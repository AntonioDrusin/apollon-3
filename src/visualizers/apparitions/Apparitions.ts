...
@visualizer("visualizer.apparitions.apparitions", "2d")
export class Apparitions implements IVisualizer {
    ...
    @numberInput("visualizer.apparitions.colorSaturation", 0, 1)
    ...
    @selectOption("visualizer.apparitions.penDownPosition", ["visualizer.apparitions.same", "visualizer.apparitions.randomized"])
    private pendownPosition: number = 0;
    @selectOption("visualizer.apparitions.movementMapping", ["visualizer.apparitions.toroid", "visualizer.apparitions.bounce"])
